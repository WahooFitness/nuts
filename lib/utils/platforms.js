...
function detectPlatform(platform) {
    ...
    if (_.includes(name, 'x86')
        || _.includes(name, 'ia32')
        || _.includes(name, 'i386')
        || _.includes(name, prefix+'_32')) suffix = '32';
    if (_.includes(name, 'x86_64') || _.includes(name, 'x64') || _.includes(name, 'amd64') || _.includes(name, prefix+'_64')) suffix = '64';
    if (_.includes(name, 'arm64')) suffix = 'arm64';
