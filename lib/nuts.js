...
Nuts.prototype.determineChannel = function(req) {
    if(req.prams.version && req.params.version.indexOf('beta') === -1) {
        return '*';
    } else {
        return 'stable';
    }
...
Nuts.prototype.onUpdate = function(req, res, next) {
    ...
    var platform = req.params.platform;
    var channel = req.params.channel || this.determineChannel(req);
